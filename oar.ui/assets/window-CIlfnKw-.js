...
<script setup lang='ts'> 
    ...
    const s1 = ref(false) 
<\/script>
`},{default:s(()=>[e(y)]),_:1}),a[4]||(a[4]=d("h2",null,"默认位置",-1)),a[5]||(a[5]=d("p",null,"通过 defaultPosition 设置窗口初始位置，默认为 { x: 0, y: 0 }。",-1)),e(c,{code:`<template>
    <div style='display:flex; gap:10px'> 
