import{_ as s}from"./index.vue_vue_type_script_setup_true_lang-DTHUNUlY.js";import{d as u,h as v,r as i,o,c as m,e as f,f as e,a as n,w as c,g as _,_ as b}from"./index-akwbTLob.js";const O=u({__name:"Oar13",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{default:"",placeholder:"Please input",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),I=u({__name:"Oar14",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{placeholder:"Please input",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),V=u({__name:"Oar15",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{placeholder:"Please input",disabled:"",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),g=u({__name:"Oar16",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{placeholder:"Please input",readonly:"",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),h=u({__name:"Oar17",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{clearable:"",placeholder:"Please input",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),x=u({__name:"Oar18",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{type:"password",placeholder:"password",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),y=u({__name:"Oar19",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{clearable:"",maxlength:"50",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r)},null,8,["modelValue"])}}}),w=u({__name:"Oar20",setup(p){const a=v("");return(t,d)=>{const l=i("OarInput");return o(),m(l,{clearable:"",modelValue:a.value,"onUpdate:modelValue":d[0]||(d[0]=r=>a.value=r),modelModifiers:{lowercase:!0}},null,8,["modelValue"])}}}),q={class:"markdown-body"},P=u({__name:"input",setup(p){return(a,t)=>(o(),f("div",q,[t[0]||(t[0]=e("h1",null,"Input输入框",-1)),t[1]||(t[1]=e("p",null,"通过键盘输入字符",-1)),t[2]||(t[2]=e("h2",null,"默认样式",-1)),t[3]||(t[3]=e("p",null,"浏览器默认自带的样式，只对其width/height/color/font-size保持一致，其余均为浏览器自带样式",-1)),t[4]||(t[4]=e("blockquote",null,[e("p",null,"clearable属性不会生效，maxlength属性不会显示输入字符")],-1)),n(s,{code:`<template>
...
<script setup lang='ts'>
    ...
    const input = ref<string>('')
<\/script>
`},{default:c(()=>[n(h)]),_:1}),t[12]||(t[12]=e("h2",null,"密码框",-1)),t[13]||(t[13]=e("p",null,'使用 type="password" 即可得到一个可切换显示隐藏的密码框',-1)),n(s,{code:`<template>
...
<script setup lang='ts'>
    ...
    const input = ref<string>('')
<\/script>
`},{default:c(()=>[n(x)]),_:1}),t[14]||(t[14]=e("h2",null,"输入长度限制",-1)),t[15]||(t[15]=e("p",null,"使用maxlength属性，来控制输入的最大字数",-1)),n(s,{code:`<template>
